...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-rjp-ontario/';
  var LS_CHANGES = 'tf_rjp_change_log_v1';
  var LS_PURCHASED = 'tf_rjp_purchased_v1';
  ...
  var demoEdits = [
    ...
    },
    {
      ...
      apply: function () {
        if (heroH) {
          heroH.innerHTML = 'Kitchen, bath,<br>and additions,<br>quoted <em>before</em> we start.';
        }
      }
    },
    {
